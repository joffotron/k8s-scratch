...
AWS_S3_BUCKET=iflix-staging-k8s-artifacts
...
MASTER_NAME="${INSTANCE_PREFIX}-api"
MASTER_TAG="${INSTANCE_PREFIX}-api"
MINION_TAG="${INSTANCE_PREFIX}-app"
MINION_SCOPES=""
